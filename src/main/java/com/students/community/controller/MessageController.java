...
import com.students.community.service.MessageService;
...
public class MessageController implements CommunityConstant {
    ...
    public String getLetterDetail(@PathVariable("conversationId") String conversationId, Model model, Page page) {
        ...
        List<Message> letterList = messageService.findLetters(conversationId, page.getOffest(), page.getLimit());
    ...
    public String getNoticeDetail(@PathVariable("topic") String topic, Page page, Model model) {
        ...
        List<Message> noticeList = messageService.findNotices(user.getId(), topic, page.getOffest(), page.getLimit());
