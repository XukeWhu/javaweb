...
public class UserController {
    ...
    public String updatePassword(String oldPassword, String newPassword, String secondPassword, Model model){
        User user = hostHolder.getUser();
        if(StringUtils.isBlank(newPassword)){
            model.addAttribute("newError","新密码为空!");
            return "/site/setting";
        }

        if(!newPassword.equals(secondPassword)){
            model.addAttribute("secondError","两次密码不同!");
            return "/site/setting";
        }
